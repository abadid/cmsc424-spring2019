...
public class LockContext {
    ...
    /**
     * Escalate TRANSACTION's lock from descendants of this context to this level, using
     * the least permissive lock necessary. There should be no descendant locks after this
     ...
     * else calls to LockContext#saturation will not work properly.
     *
     * @throws NoLockHeldException if TRANSACTION has no lock on descendants
     * @throws UnsupportedOperationException if context is readonly
     */
