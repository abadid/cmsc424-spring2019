...
public class TestInnerNode {
    ...
    public void resetMembers() throws IOException {
        ...
        this.allocator = new PageAllocator(file.getAbsolutePath(), false, null);
        ...
        LeafNode leaf2 = new LeafNode(meta, keys2, rids2, sibling2, null);
        ...
        LeafNode leaf1 = new LeafNode(meta, keys1, rids1, sibling1, null);
        ...
        LeafNode leaf0 = new LeafNode(meta, keys0, rids0, sibling0, null);
    ...
    public void testToAndFromBytes() throws IOException {
        ...
        for (int i = 0; i < 2 * d; ++i) {
            ...
            InnerNode inner = new InnerNode(meta, keys, children, null);
